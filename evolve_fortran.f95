...
! ===========================================
    ...
    ! =======================================
    real , intent(out) :: new_XYT(N,3), vel
    ! =======================================
...
! ===========================================
    ...
    real :: dx, dy, r, th, dtheta, val, cone_angle_reduced, sp_th
    real :: dx2, dy2, r2, dtheta2, dark, ss=6.2/2.
    ...
    allocate(edges(cones+1))
    do i = 0, cones
        edges(i+1) = -cone_angle/2. + cone_angle*i/cones  
    enddo 
